...
import { ILoginInputDTO, ILoginOutputDTO, ISignupInputDTO, IsignupInputDTO, User, USER_ROLES } from "../models/User"
...
export class UserBusiness {
    ...
    public signup = async (input: ISignupInputDTO) => {
        ...
        const isEmailAlreadyExists = await this.userDatabase.findShowEmail(email)
        ...
        await this.userDatabase.createShow(user)
        ...
        const response: ISignupInputDTO = {
