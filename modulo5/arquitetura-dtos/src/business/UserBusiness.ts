...
import { IDeleteUserInputDTO, IEditUserInputDTO, IGetUsersDBDTO, IGetUsersInput, IGetUsersOutInputDTO, IGetUsersUser, ILoginInputDTO, ISignupInputDTO, User, USER_ROLES } from "../models/User"
...
export class UserBusiness {
    ...
    public getUsers = async (input: IGetUsersInput) => {
        ...
        const response: IGetUsersOutInputDTO = {
            users
        }
...
if (name && typeof name !== "string")  {
    ...
    if (payload.role === USER_ROLES.NORMAL) {
        if(payload.id !==idToEdit) {
            throw new Error("Usuário normais só podem editar a própria conta")
    ...
    const response = {
        message: "Edição realizado com sucesso"
    }
